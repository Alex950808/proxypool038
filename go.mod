...
require (
	...
	pkg.go.dev/golang.org/x/crypto v0.0.0-20200820211705-5c72a883971a // indirect
	pkg.go.dev/golang.org/x/sys v0.0.0-20200814200057-3d37ad5750ed // indirect
	pkg.go.dev/golang.org/x/xerrors v0.0.0-20200804184101-5ec99f83aff1 // indirect
